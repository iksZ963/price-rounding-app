      ...
      <div className="relative flex h-screen w-full max-w-[480px] mx-auto flex-col bg-white dark:bg-zinc-900 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col px-4 pt-2 pb-2">
          ...
          <div className="flex flex-col items-center justify-center py-2 mb-1.5">
            ...
            <div
              className={`relative w-full rounded-xl p-1.5 transition-all cursor-pointer ${
                activeInput === "price"
          ...
          <div className="mb-1.5">
            <div className="flex justify-between items-center px-3 py-1.5 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-100 dark:border-zinc-800">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="h-8 w-px bg-zinc-200 dark:bg-zinc-700 cursor-help"></div>
                </TooltipTrigger>
          ...
          {/* Divider */}
          <div className="w-full flex items-center gap-2 opacity-60 mb-1.5">
          ...
          {calculations.subtotal > 0 && calculations.direction === "none" && (
            <div className="mb-1.5 p-2.5 bg-emerald-50 dark:bg-emerald-950/20 rounded-xl border border-emerald-200 dark:border-emerald-900 text-center">
              ...
              <p className="text-[10px] text-emerald-600 dark:text-emerald-500">No rounding needed</p>
            </div>
          )}
          ...
          {!(calculations.subtotal > 0 && calculations.direction === "none") && (
            <div className="grid grid-cols-2 gap-2 mb-1.5">
              ...
              <div className="flex flex-col bg-white dark:bg-zinc-800 rounded-xl p-2.5 shadow-sm border-2 border-zinc-100 dark:border-zinc-700 relative overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-1.5 mt-auto">
            ...
            <button
              ...
              className="h-11 rounded-lg bg-white dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white font-bold text-lg hover:bg-zinc-50 dark:hover:bg-zinc-700 active:scale-95 transition-all shadow-sm"
            >
              1
            </button>
            <button
            ...
            <button
              ...
              className="h-11 rounded-lg bg-red-50 dark:bg-red-950/20 border-2 border-red-200 dark:border-red-900 text-red-600 dark:text-red-400 font-bold text-lg hover:bg-red-100 dark:hover:bg-red-950/40 active:scale-95 transition-all shadow-sm flex items-center justify-center"
            >
